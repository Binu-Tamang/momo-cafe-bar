    ...
    <div class="row">
      <div class="col-md-4 col-sm-6">
        <div class="food-box-wrap">
          <img src="assets/img/ficon.png" alt="icon images">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="food-box-wrap">
          <img src="assets/img/ficon2.png" alt="icon images">
      ...
      <div class="col-md-4 col-sm-6">
        <div class="food-box-wrap">
          <img src="assets/img/ficon3.png" alt="icon images">
    ...
    <div class="row">
      <div class="col-md-6 col-sm-12 col-lg-6">
        <div class="food-review-wrap">
          ...
          <h2 class="web-tittle">Some Words From Our Loyal Guests</h2>
          ...
          <div class="social-platform">
            <img src="assets/img/google-review-logo.png" alt="google">
            <img src="assets/img/trip.png" alt="tripadvisor">
            <img src="assets/img/yelp-review-logo.png" alt="yelp">
            <img src="assets/img/facebook-review-logo.png" alt="facebook">
          </div>
        </div>
      </div>
      <div class="col-md-6 col-sm-12 col-lg-6">
