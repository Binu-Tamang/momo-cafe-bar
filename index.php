        ...
        <div class="row">
            <div class="col-md-5 col-sm-12">
                <div class="left-banner">
                    ...
                    <a href="#" class="default-btn"> Explore Menu<span></span><i
            ...
            <div class="col-md-7 col-sm-12">
                <div class="right-banner">
                    <div class="owl-carousel owl-theme banner-slider">
                        ...
                        <div class="item"
                            data-dot='<img rel="preload" src="assets/img/b-2.png" alt="food-slider" as="image">'>
                            <div class="banner-img-cover">
                                <img rel="preload" src="assets/img/b-2.png" alt="food-slider" as="image">
                            </div>
                        </div>
                        <div class="item"
                            data-dot='<img rel="preload" src="assets/img/b-3.png" alt="food-slider" as="image">'>
                            <div class="banner-img-cover">
                            ...
                            <div class="menu-list">
                                ...
                                <div class="menu-list-details">
                                    ...
                                    <p>Spinach cooked with homemade cottage with house special sauce <span
                                            class="dots">...</span><span class="more" style="display: none;">erisque
                        ...
                        <div class="row g-3">
                            <div class="col-md-4 col-sm-6">
                                <div class="input-group">
                                    <input type="text" id="name" name="name" class="form-control border-2" required
                                        placeholder="Name" aria-label="Name" aria-describedby="nameError"
                                        style="height: 40px;">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="input-group">
                                    <input type="email" id="email" name="email" class="form-control border-2" required
                                        placeholder="Email Address" aria-label="Email Address" style="height: 40px;">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="input-group flatpickr">
                                    <input type="text" id="time" name="time" class="form-control border-2 time-input"
                                        required placeholder="Time" style="height: 40px;" data-input>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="input-group">
                                    <input type="tel" id="phone" name="phone"
                                        ...
                                        required placeholder="Mobile No." aria-label="Mobile No." style="height: 40px;">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="input-group flatpickr">
                                    <input type="text" id="date" name="date" class="form-control border-2" required
                                        placeholder="Date" style="height: 40px;" data-input>
                                    <a class="input-button" title="toggle" data-toggle>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="input-group custom-select">
                                    <input type="number" id="number-guest" name="number_guest"
                                        class="form-control border-2" required placeholder="Number of Guests"
                                        aria-label="Numbe of Guests" style="height: 40px;">
                                    <!-- <span class="input-group-text"><i class="fa-solid fa-angle-down"></i></span> -->
                                </div>
                            </div>
                        </div>
                        <div class="text-left pt-3">
                            <button type="submit" class="default-btn">Book Now <span></span><i
