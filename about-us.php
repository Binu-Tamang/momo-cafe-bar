                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="abt-box-wrap">
                            <div class="move-mouse mouse_move abt-move" id="main">
                                <img loading="lazy" class="mouse" value="1.5" src="assets/img/capcicum.png" alt="food"
                                    id="bg-1" data-depth="30"
                                    style="transform: translateX(12.7444px) translateY(-46.9278px);">
                                <img loading="lazy" class="mouse" value="0.8" src="assets/img/cherry-tomato.png"
                                    alt="food" id="bg-2" data-depth="40"
                                    style="transform: translateX(13.88px) translateY(-21.7044px);">
                                <img loading="lazy" class="mouse" value="1.5" src="assets/img/leaf-3.png" alt="food"
                                    id="bg-3" data-depth="20"
                                    style="transform: translateX(12.7444px) translateY(-46.9278px);">
                                <img loading="lazy" class="mouse" value="1.5" src="assets/img/capcicum.png" alt="food"
                                    id="bg-4" data-depth="25"
                                    style="transform: translateX(12.7444px) translateY(-46.9278px);">
                            </div>
                            ...
                            <div class="add-video">
                                <div class="wrapper">
                                    <div class="video-main">
                                        ...
                                        <a href="#" class="video video-popup mfp-iframe" data-lity><i
                    ...
                    <div class="col-md-6">
                        <div class="story-box-wrap">
                            <span class="small-heading text-left">Our Story</span>
                            ...
                            <div class="text-left pt-3">
                                <a href="#" class="yellow_btn"> Explore Menu <span></span><i
                    ...
                    <div class="tst-cta-frame">
                        <div class="tst-cta">
                            ...
                            <div class="text-left pt-5 two-btn">
                                <a href="#" class="default-btn"> Reservation<span></span><i
                                        class="fa-solid fa-arrow-right-long"></i></a>
                                <a href="#" class="yellow_btn mx-4"> Get in touch <span></span><i
                                        class="fa-solid fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6"> <!-- image --> <noscript><img decoding="async" src="assets/img/reserv-hand.png"
                            alt="" class="tst-cta-image tst-fade-up"></noscript><img decoding="async"
                        src="assets/img/reserv-hand.png" data-src="assets/img/reserv-hand.png" alt=""
                        class="tst-cta-image tst-fade-up lazyloaded tst-active"> <!-- image end --></div>
            </div>
        </div>
    </section>
